...
import { Seed, Users, Star, MessageSquare, Database, TrendingUp, AlertCircle, CheckCircle } from 'lucide-react'
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 flex items-center">
                  <Seed className="w-6 h-6 mr-2 text-green-600" />
